 ...
 */
package pontocerto.Application.CadastroFretado;
 ...
 * @author thiag
 */
public class CadastroFretadoUI extends DefaultCode
{

    /**
     * Creates new form CadastroFretadoUI
     */
    public CadastroFretadoUI()
    {
        initComponents();
        validaAcessoUsuario();
    }
    ...
    private void initComponents()
    {
        ...
        painelCadastroFretado = new javax.swing.JPanel();
        ...
        btnCadastrarFretado = new javax.swing.JButton();
        lblMensagemErroCadastroFretado = new javax.swing.JLabel();
        ...
        painelCadastroFretado.setBackground(new java.awt.Color(255, 255, 255));
        painelCadastroFretado.setPreferredSize(new java.awt.Dimension(728, 585));

        jLabel10.setBackground(new java.awt.Color(255, 255, 255));
        jLabel10.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("Cadastro de Fretado");
        ...
        btnCadastrarFretado.setBackground(new java.awt.Color(51, 102, 255));
        btnCadastrarFretado.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        btnCadastrarFretado.setForeground(new java.awt.Color(255, 255, 255));
        btnCadastrarFretado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pontocerto/Images/save.png"))); // NOI18N
        btnCadastrarFretado.setText("Salvar");
        btnCadastrarFretado.setBorder(null);
        btnCadastrarFretado.addMouseListener(new java.awt.event.MouseAdapter()
        {
            public void mouseClicked(java.awt.event.MouseEvent evt)
            {
                btnCadastrarFretadoMouseClicked(evt);
            }
        });

        lblMensagemErroCadastroFretado.setBackground(new java.awt.Color(255, 255, 255));
        lblMensagemErroCadastroFretado.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        javax.swing.GroupLayout painelCadastroFretadoLayout = new javax.swing.GroupLayout(painelCadastroFretado);
        painelCadastroFretado.setLayout(painelCadastroFretadoLayout);
        painelCadastroFretadoLayout.setHorizontalGroup(
            painelCadastroFretadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(painelCadastroFretadoLayout.createSequentialGroup()
                .addGroup(painelCadastroFretadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painelCadastroFretadoLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabel10, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(painelCadastroFretadoLayout.createSequentialGroup()
                        .addGap(64, 64, 64)
                        .addGroup(painelCadastroFretadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(lblMensagemErroCadastroFretado, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addGroup(painelCadastroFretadoLayout.createSequentialGroup()
                                ...
                                .addComponent(btnCadastrarFretado, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 58, Short.MAX_VALUE)))
                .addContainerGap())
        );
        painelCadastroFretadoLayout.setVerticalGroup(
            painelCadastroFretadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(painelCadastroFretadoLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(jLabel10)
                .addGap(18, 18, 18)
                .addComponent(lblMensagemErroCadastroFretado)
                .addGap(20, 20, 20)
                .addComponent(jLabel11)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(painelCadastroFretadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(painelCadastroFretadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnCadastrarFretado, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35))
        );
        ...
        painelPrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(painelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painelPrincipalLayout.createSequentialGroup()
                    ...
                    .addComponent(painelCadastroFretado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        painelPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(painelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(painelCadastroFretado, javax.swing.GroupLayout.DEFAULT_SIZE, 555, Short.MAX_VALUE))
        );
    ...
    private void btnCadastrarFretadoMouseClicked(java.awt.event.MouseEvent evt)//GEN-FIRST:event_btnCadastrarFretadoMouseClicked
    {//GEN-HEADEREND:event_btnCadastrarFretadoMouseClicked
        lblMensagemErroCadastroFretado.setVisible(false);
        ...
        try
        {
            ...
            {
                if (!CadastraFretadoValidation.validaSeExisteMotorista(fretado.getMotorista()))
                {
                    MensagemAlertaErro("Motorista não cadastrado. Por favor, realizar o cadastro na tela de usuários", true);
                }
                else if (!CadastraFretadoValidation.validaMotoristaPorFretadoHorario(fretado))
                {
                    MensagemAlertaErro("Motorista já cadastrado para o fretado e horario informados", true);
                }
                else
                {
                    CadastraFretadoValidation.cadastraFretado(fretado);
                    MensagemAlertaErro("Fretado cadastrado com sucesso", false);
                }
            }
        }
        catch (Exception ex)
    ...
    }//GEN-LAST:event_btnCadastrarFretadoMouseClicked
    ...
    private void MensagemAlertaErro(String mensagem, boolean erro)
    {
        ...
        lblMensagemErroCadastroFretado.setVisible(true);
        lblMensagemErroCadastroFretado.setForeground(cor);
        lblMensagemErroCadastroFretado.setText(mensagem);
    }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(CadastroFretadoUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new CadastroFretadoUI().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnCadastrarFretado;
    ...
    private javax.swing.JLabel lblMensagemErroCadastroFretado;
    private javax.swing.JLabel lblSair;
    private javax.swing.JLabel lblUsuario;
    private javax.swing.JPanel painelCadastroFretado;
