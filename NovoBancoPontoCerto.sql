...
insert into Enderecos (CEP, Bairro, Rua, Cidade, Estado) values(9896160, 'Planalto', 'Rua Cassiano Gabus Mendes', 'Sao Bernardo do Campo', 'SP')
insert into Enderecos (CEP, Bairro, Rua, Cidade, Estado) values(9895110, 'Planalto', 'Rua Benedito Conrado Filho', 'Sao Bernardo do Campo', 'SP')
